...
def __main__():
    ...
    file_list = list_files(video_input_folder, video_format) # list_file innately has nat sort, don't think we need another sort in ln 25, check if both outputs are the same.
    grouped_files = {}
